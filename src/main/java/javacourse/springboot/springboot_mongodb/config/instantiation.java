...
public class instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, Instant.parse("2018-03-21T19:00:07Z"), "partiu viagem"
                , "Vou viajar para São Paulo. Abraços!", new AuthorDTO(maria));
        Post post2 = new Post(null, Instant.parse("2018-03-23T08:00:07Z"), "Bom dia"
                , "Acordei feliz hoje!", new AuthorDTO(maria));

        CommentDTO c1 = new CommentDTO("Boa viagem mano!", Instant.parse("2018-03-21T19:50:00Z"), new AuthorDTO(alex));
        CommentDTO c2 = new CommentDTO("Aproveite!", Instant.parse("2018-03-22T16:00:00Z"), new AuthorDTO(bob));
        CommentDTO c3 = new CommentDTO("Tenha um ótimo ", Instant.parse("2018-03-23T08:50:00Z"), new AuthorDTO(alex));
